...
data class DailyCashUiState(
    ...
    val cashPaluwaganContributions: Double = 0.0,
    val gcashPaluwaganContributions: Double = 0.0,
    val onlineBankingPaluwaganContributions: Double = 0.0,
    val otherPaluwaganContributions: Double = 0.0,
